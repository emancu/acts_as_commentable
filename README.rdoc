...
Install
   ...
   ** Rails 3:
    script/plugin install http://github.com/eMancu/acts_as_commentable.git

   ** Rails 2:
    script/plugin install http://github.com/eMancu/acts_as_commentable.git -r 2.x
   ...
   * To install as a gem:
    ...
    Install the gem(s):
    sudo gem install emancu-acts_as_commentable

    add the folloowing line to your environment.rb
    config.gem 'emancu-acts_as_commentable', :lib => 'acts_as_commentable', :source => "http://gems.github.com"
